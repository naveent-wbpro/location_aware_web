    ...
    <div class="col-sm-4">
        ...
        @if (isset($code_snippet_data))
            <div style="height: 300px; width: 100%">
                <div id='location-aware-map'>LocationAware.io is loading...</div><script id='location-aware-script' data-company-id='32' data-api-key='{{ $code_snippet_data->api_key }}' src='https://locationaware.io/js/location_aware_snippet.js'></script>
            </div>
        @endif
    </div>
    <div class="col-sm-8">
